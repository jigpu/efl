...
EAPI extern const Eo_Event_Description _EVAS_OBJECT_EVENT_AXIS_UPDATE;
...
#define EVAS_OBJECT_EVENT_AXIS_UPDATE (&(_EVAS_OBJECT_EVENT_AXIS_UPDATE))
...
enum
{
   ...
   EVAS_CANVAS_SUB_ID_EVENT_INPUT_AXIS_UPDATE,
