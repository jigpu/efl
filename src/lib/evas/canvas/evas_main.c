...
_class_constructor(Eo_Class *klass)
{
   const Eo_Op_Func_Description func_desc[] = {
        ...
        EO_OP_FUNC(EVAS_CANVAS_ID(EVAS_CANVAS_SUB_ID_EVENT_INPUT_AXIS_UPDATE), _canvas_event_input_axis_update),
...
static const Eo_Op_Description op_desc[] = {
     ...
     EO_OP_DESCRIPTION(EVAS_CANVAS_SUB_ID_EVENT_FEED_AXIS_UPDATE, "Axis update event feed."),
     ...
     EO_OP_DESCRIPTION(EVAS_CANVAS_SUB_ID_EVENT_INPUT_AXIS_UPDATE, "Axis update event input."),
